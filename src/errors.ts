...
const NO_DEVICE = [
  ...
  "  2. It has not switched itself off. The default auto-off is 3 minutes, and the",
  "     device then disappears from USB entirely. Raise it under",
  "     Settings > Shell > Auto-off time (3/5/10/30 minutes, or Never).",
  ...
  switch (op) {
    case "transaction":
      return (
        ...
        "EIP-155 chain binding, which firmware 1.4.0 and later refuse because it can be replayed " +
        "on any EVM chain."
      );
    case "typed-data":
      return (
