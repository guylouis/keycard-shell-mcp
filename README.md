...
| The install ends in pages of `gyp` errors | The prebuilt USB component could not be downloaded, so npm tried to compile it instead. This is usually a network hiccup. Run the install again. You do not need to install a compiler. |
